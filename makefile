...
help:
	@echo "install"
	@echo "        Install xvfm and dependencies"
	@echo "uninstall"
	@echo "        Unstall xvfm"
	@echo "lint"
	...
	@echo "conda-env"
	@echo "        Create conda environment 'xvfm' with dev setup"
	@echo "darglint-check"
...
test:
	@pytest -vx --run-optional-tests=expensive --cov=xvfm --doctest-modules test xvfm

test-light:
	@pytest -vx --cov=xvfm --doctest-modules test xvfm
...
darglint-check:
	@darglint --verbosity 2 xvfm test
